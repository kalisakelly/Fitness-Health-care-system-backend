...
export class EmailController {
    ...
    async sendMail(): Promise<any> {
        try {
            const result = await this.sendActivationEmail("kalisakelly@icloud.com", "kelly", "123435424");
    ...
    async sendActivationEmail(email: string, firstName: string, otp: string) {
        const htmlBody = `
            <!DOCTYPE HTML
                                ...
                                <td
                                  ...
                                  <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 140%;"><span
                                        style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello ${firstName},</span></p>
